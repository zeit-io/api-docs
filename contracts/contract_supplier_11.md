...
| "cntr_notice_period"                | 5                           | Notice period in days.                                                                                                                                                 | YES           |
...
| "cntr_created_by_oration"           | "Max Mustermann"            | Name of the person who created the contract. Is used for the invitation email.                                                                                         | NO            |
| "cntr_max_hours_per_day"            | "28800"                     | Max hours per day allowed to record, in seconds.                                                                                                                       | NO            |
| "cntr_max_hours_per_tr"             | "28800"                     | Max hours per TimeRecord allowed to record, in seconds.                                                                                                                | NO            |
| "cntr_half_day_allowed"             | true                        | When day rates are configured, allowed to recrod a half day.                                                                                                           | NO            |
| "cntr_quarter_day_allowed"          | true                        | When day rates are configured, allowed to recrod a quarter day.                                                                                                        | NO            |
| "cntr_three_quarter_day_allowed"    | true                        | When day rates are configured, allowed to recrod a three-quarter day.                                                                                                  | NO            |
